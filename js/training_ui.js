...
function tuExerciseVisualSVG(exercise,compact){
  ...
  return '<svg class="exercise-diagram-svg" viewBox="0 0 800 600" role="img" aria-label="Diagrama de '+title+'"><defs><marker id="arr" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto"><path d="M0,0 L0,6 L9,3 z" fill="#fff"/></marker></defs><rect width="800" height="600" rx="22" fill="#fff"/><rect x="0" y="0" width="800" height="82" rx="22" fill="#fff"/><rect x="28" y="18" width="54" height="54" rx="14" fill="#c8102e"/><text x="55" y="55" text-anchor="middle" fill="#fff" font-size="28" font-weight="900">'+tuEsc(String(exercise?.visual_order||""))+'</text><text x="100" y="42" fill="#111827" font-size="'+(compact?18:22)+'" font-weight="900">'+title.slice(0,48)+'</text><text x="100" y="66" fill="#64748b" font-size="13">'+tuEsc(exercise?.escalao||"Sub-8")+' · '+duration+' min · '+space+'</text><rect x="40" y="105" width="720" height="380" rx="18" fill="#a90f25"/><path d="M40 295 H760 M400 105 V485" stroke="rgba(255,255,255,.3)" stroke-width="2"/>'+field+'<rect x="40" y="505" width="720" height="70" rx="14" fill="#f8fafc"/><text x="60" y="532" fill="#111827" font-size="13" font-weight="900">OBJETIVO</text><text x="60" y="554" fill="#334155" font-size="12">'+tuEsc(String(exercise?.objetivo||"").slice(0,92))+'</text></svg>';
}
